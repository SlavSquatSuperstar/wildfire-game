...
/**
 * A Runner class for a standalone Greenfoot project.
 * <p>
 * Source: <a href="https://github.com/benoitheinrich/greenfoot-runner">Greenfoot Runner</a>
 */
public abstract class GreenfootRunner {
    private final Configuration mainConfiguration;
    private String scenarioName;

    protected GreenfootRunner(Configuration configuration) {
    ...
    private void initProperties() {
        if (scenarioName == null) {
            ...
            try {
                ...
                final GreenfootRunner.Configuration configuration = mainConfiguration;
    ...
    public static final class Configuration {
         ...
         */
        public static GreenfootRunner.Configuration forWorld(final Class<? extends World> worldClass) {
            return new GreenfootRunner.Configuration(worldClass, "No title", false, false);
        }
         ...
         * @return the new configuration.
         */
        public GreenfootRunner.Configuration projectName(final String projectName) {
            return new GreenfootRunner.Configuration(worldClass, projectName, lockScenario, hideControls);
        }
         ...
         * @return the new configuration.
         */
        public GreenfootRunner.Configuration lockScenario(final boolean lockScenario) {
            return new GreenfootRunner.Configuration(worldClass, projectName, lockScenario, hideControls);
        }
         ...
         * @return the new configuration.
         */
        public GreenfootRunner.Configuration hideControls(final boolean hideControls) {
            return new GreenfootRunner.Configuration(worldClass, projectName, lockScenario, hideControls);
        }
    }
}
